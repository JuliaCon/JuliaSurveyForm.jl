...
4. 只考虑 Julia 的非技术方面的原因，以下哪些是您的喜欢Julia的原因？请选择所有适用的选项。
- [ ] 免费 – 无需付费即可使用 Julia
- [ ] Julia 开发者社区才华横溢且活跃
- [ ] MIT许可证
- [ ] 创建包很容易
...
5. 只考虑技术方面的话，以下哪些方面是您最不喜欢Julia的?请选择所有适用的选项。
- [ ] 生成第一个图需要太长时间
- [ ] 编译时间慢
- [ ] 软件包不像我需要的那样成熟或维护得很好
...
6. 只考虑 Julia 的非技术方面的原因，以下哪些是您不喜欢 Julia 的原因？请选择所有适用的选项。
- [ ] 我的同事、公司或合作者使用其他语言
- [ ] 我的领域或行业中没有足够的 Julia 用户
- [ ] 过时的在线教程和文档
- [ ] 整体上 Julia 用户太少了
- [ ] 我的公司、大学、客户或与我合作的其他组织不允许使用或不支持 Julia
- [ ] 文档不够好
- [ ] 网上没有足够的教学资源
- [ ] 有太多东西不知道怎么在 Julia 里实现
- [ ] 我更习惯用另一种语言
- [ ] Julia 社区不够活跃
- [ ] Julia 社区太封闭，不够热情
- [ ] Julia 社区不够多样化
...
- [ ] Julia 社区太保守，太不愿意对语言做出有用的改变
- [ ] Julia 社区在没有适当考虑的情况下轻易改变语言
- [ ] 我对与社区分享我的意见感到不舒服
- [ ] 没有不喜欢Julia的非技术原因
- [ ] 不知道
-[ ] 其他/SPECIFY
...
7. 对于您目前使用Julia的任务来说，如果不使用Julia的话，那么您有可能在使用其它哪些语言呢？请选择所有适用的选项。
- [ ] Bash, Shell, PowerShell
- [ ] C
- [ ] C++
- [ ] C#
...
- [ ] Julia中有更好的包
- [ ] 我需要Julia中的某个特定功能
- [ ] 因为我的同事用 Julia ，我想与他们合作
- [ ] 因为我的讲师或者我喜欢的一门课要用 Julia
- [ ] Julia写起来很优雅
- [ ] 以上都不是
- [ ] 不知道


9. 你通过以下哪些方式和Julia社区交流？请选择所有适用的选项。
- [ ] GitHub
...
11. 您创建过以下哪种类型的 Julia 包？请选择所有适用的选项。
- [ ] 开源并在 Julia 通用注册表中注册
- [ ] 开源且未在 Julia 通用注册表中注册
- [ ] 私有且未在 Julia 通用注册表中注册
- [ ] 以上都不是
- [ ] 不知道


12. 您为以下哪种类型的 Julia 软件包做出过贡献（非创建）？包括修改文档或提交issue。请选择所有适用的选项。
- [ ] 开源并在 Julia 通用注册表中注册
- [ ] 开源且未在 Julia 通用注册表中注册
- [ ] 私有且未在 Julia 通用注册表中注册
- [ ] 以上都不是
...
13. 您是什​​么时候开始使用 Julia 的？输入年份（从2022年至2009年）
...
18. 您在使用Julia的同时还用到了哪些云服务或者高性能计算服务？请选择所有适用的选项。
- [ ] 本地集群
- [ ] JuliaHub
...
20. 您是否参加过或打算参加 JuliaCon？请选择所有适用的选项。
- [ ] 2022（在线）
- [ ] 2021（在线）
- [ ] 2020（在线）
- [ ] 2019（巴尔的摩）
...
27. 如果是学术人员：以下哪项最能描述您？请选择所有适用的选项。
- [ ] 研究生或研究生或研究员
- [ ] 教授
- [ ] 讲师
- [ ] 本科生或本科学历的研究员
...
28. 如果是学术人员：您的主要行业或研究领域是什么？请选择所有适用的选项。
- [ ] 计算机科学
- [ ] 数学
- [ ] 物理
- [ ] 生物学
...
29. 如果是专业人员：以下哪项最能描述您？请选择所有适用的选项。
- [ ] 工程师、开发人员
- [ ] 研究员
- [ ] 分析师
- [ ] 经理
...
31. 对 Julia 进行哪些改进会让您更有可能向其他人推荐 Julia？
- [ ] 更多统计功能
- [ ] 更多网页开发功能
- [ ] 更多机器学习功能
- [ ] 减少启动时间（第一次执行某任务的时间）
...
37. 以下哪项最能描述您的种族或民族？请选择所有适用的选项。
- [ ] 白人, 高加索人, 欧洲人
- [ ] 亚洲人, 亚裔美国人
- [ ] 拉丁美洲人、拉丁裔、西班牙裔
- [ ] 黑人、非洲人、非裔美国人、加勒比黑人
- [ ] 中东、阿拉伯、波斯、土耳其
- [ ] 美洲印第安人、阿拉斯加原住民、因纽特人、原住民、梅蒂斯人
- [ ] 夏威夷原住民、太平洋岛民
- [ ] 澳大利亚原住民
- [ ] 毛利人
- [ ] 不想回答
...
40. 您是否因为以下原因而认为自己在科学或计算机领域的代表性不足：
- [ ] 年龄
- [ ] 性别
- [ ] 性别认同
- [ ] 语言或语言能力
